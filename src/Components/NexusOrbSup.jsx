...
const DiscordIcon = () => <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="1.8em" height="1.8em" viewBox="0 0 48 48">
...
const CenterFlowerIcon = () => <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 200 200" width="100%" height="100%" className="coolshapes flower-3">
...
const IconWrapper = ({
  ...
  isActive = false
            ...
            ${isHighlighted ? 'dark:bg-gray-700/50 bg-gray-100/80 border-blue-400/50 dark:shadow-blue-500/20 shadow-blue-400/30 shadow-2xl animate-breathing-glow' : `dark:bg-white/5 bg-white/60 dark:border-white/20 border-gray-300/60 ${!isActive && 'animate-float'}`}
        ...
        return <div key={icon.id} className="absolute z-20" style={{
          ...
          transition: 'transform 1.5s cubic-bezier(0.22, 1, 0.36, 1)'
                            ...
                            <div className="-translate-x-1/2 -translate-y-1/2 relative">
                                <div className="absolute inset-[-20px] bg-blue-500/20 dark:bg-blue-500/30 rounded-full blur-2xl" style={{
