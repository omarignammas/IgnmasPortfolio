...
const Footer = () => {
  ...
  return <footer className="bg-[#160424] mt-10  dark:from-purple-900 dark:to-black text-purple-900 dark:text-white py-12 px-4 font-inter border-t border-purple-400 dark:border-purple-800">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="flex items-center space-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 200 200" width="40" height="40" className="coolshapes flower-1">
              ...
              mixBlendMode: "overlay"
                ...
                <path fill="purple" stroke="transparent" d="M200 0H0v200h200V0z" filter="url(#cs_noise_1_flower-1)"></path>
              </g>
              <defs>
            ...
            <h3 className="text-3xl font-bold font-Poppins text-purple-400 dark:text-teal-400">IGNMAS</h3>
          </div>
          <p className="text-purple-300 dark:text-purple-300 text-sm leading-relaxed">
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-3">
            ...
            <li><a href="#" className="text-purple-400 dark:text-purple-300 hover:text-blue-400 dark:hover:text-teal-400 transition-colors duration-300">Privacy Policy</a></li>
            <li><a href="#" className="text-purple-400 dark:text-purple-300 hover:text-blue-400 dark:hover:text-teal-400 transition-colors duration-300">Terms of Service</a></li>
            <li><a href="#" className="text-purple-400 dark:text-purple-300 hover:text-blue-400 dark:hover:text-teal-400 transition-colors duration-300">Careers</a></li>
          </ul>
        </div>
      ...
      {}
      <div className="text-center text-purple-500 dark:text-purple-400 text-sm pt-10 mt-10 border-t border-purple-300 dark:border-purple-700">
        <p>&copy; {new Date().getFullYear()} Your Brand. All rights reserved.</p>
        <p className="mt-1">Designed with <span className="text-red-500">&hearts;</span> by Ignmas</p>
      </div>
    </footer>;
};
