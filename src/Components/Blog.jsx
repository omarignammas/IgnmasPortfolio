...
const projects = [
  {
    id: 1,
    name: 'SpringBoot Microservice Architecture',
  ...
  {
    id: 2,
    name: 'React useState Hook Managmenet',
  ...
  {
    id: 5,
    name: 'Team Communication Advices',
  ...
  {
    id: 6,
    name: 'How to Learn the max from your Uni Experience',
...
const Project = () => {
  ...
  return (
    <section id="ProjectSection"  className="min-h-screen bg-[#160424] py-20 px-6 pointer-events-none">
      <FloatingDots />
      <NavLink to={'/'}>
          <div className='flex w-20 hover:border-white flex-1 font-normal backdrop-blur-xl opacity-85 rounded-full shadow-sm p-3 pt-2 pb-2 gap-2 text-md lg:gap-10 bg-white/20 border border-white/3 pointer-events-auto'>
        
              <p className="font-Poppins font-semibold hover:text-white text-purple-300">Home</p>

        
          </div>
        </NavLink>
      <div className="max-w-7xl mt-5 mx-auto pointer-events-none">
        {/* Header */}
        <motion.div
        ...
        >
          <p className=" text-5xl sm:text-6xl font-Poppins text-purple-400 font-bold">
            Blog
          </p>
          <h4 className="text-2xl sm:text-3xl mt-5 font-semibold font-Poppins text-purple-300">
        ...
        >
          {projects.map((project) => (
            ...
            >
              ...
              {/* Card Content */}
              <div className="p-6">
                <h3 className="text-xl  font-medium font-Poppins text-purple-300 mb-3 group-hover:text-purple-300 transition-colors duration-200">
                  {project.name}
                </h3>
                
                <p className="text-purple-400 font-Poppins text-sm mb-4 line-clamp-2">
                  {project.description}
                </p>
